...
export const Footer: React.FC = () => (
  <footer className="container mx-auto max-w-screen-lg py-10">
    <span className="text-[48px] text-dark-blue dark:text-salmon">Want to start a Project?</span>
    <Link href="mailto:ilham.abdillah.alhamdi@gmail.com" className="text-[120px] font-bold text-tosca dark:text-rose">Contact Me</Link>
