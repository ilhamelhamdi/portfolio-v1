...
export const Header: React.FC<HeaderProps> = (props) => {
    ...
    return (
        <header className={`w-full h-[64px] md:h-[80px] flex justify-between items-center px-[24px] md:px-[60px] z-30 fixed ${props.isMenuOpen ? 'bg-transparent' : 'bg-black/5 dark:bg-white/5'}`}>
            <Link href={"/"}>
